...
from my_app.product.models import Category, CategoryForm
from my_app.product import root

from collections import namedtuple

categoryBp = Blueprint('category',__name__, url_prefix=root)
...
@categoryBp.route('/category/<int:id>')
def show(id):
