...
from my_app.product.models import Product, Category, ProductForm
...
productBp = Blueprint('product',__name__, url_prefix=root)

import time

@productBp.route('/test2')
...
@productBp.route('/show2',defaults={'id':28})
@productBp.route('/show2/<int:id>')
def show2(id):
   product = Product.query.get_or_404(id)   
   return render_template('product/show.html', product=product)
